...
dfVoitures.to_csv('C:/Users/MOMO/Desktop/python/voituresOccasionsBySpoticar.csv', index=False, sep='\t', encoding='utf-8-sig')
"""
with open('C:/Users/MOMO/Desktop/python/voituresOccasionsBySpoticar.csv', 'w', newline='') as file:
